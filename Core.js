 ...
 if(//.test(command)) link = "https://textpro.me/online-thunder-text-effect-generator-1031.html"
  ...
  if(//.test(command)) link = "https://textpro.me/create-3d-realistic-text-effect-on-the-beach-online-1018.html"
   ...
   if(//.test(command)) link = "https://textpro.me/create-a-cloud-text-effect-on-the-sky-online-1004.html"
    if(//.test(command)) link = "https://textpro.me/3d-luxury-gold-text-effect-online-1003.html"
    if(//.test(command)) link = "https://textpro.me/3d-gradient-text-effect-online-free-1002.html"
    if(//.test(command)) link = "https://textpro.me/create-blackpink-logo-style-online-1001.html"
    if(//.test(command)) link = "https://textpro.me/create-realistic-vintage-style-light-bulb-1000.html"
    if(//.test(command)) link = "https://textpro.me/create-realistic-cloud-text-effect-online-free-999.html"
    if(//.test(command)) link = "https://textpro.me/create-a-cloud-text-effect-in-the-sky-online-997.html"
    if(//.test(command)) link = "https://textpro.me/write-in-sand-summer-beach-free-online-991.html"
    if(//.test(command)) link = "https://textpro.me/sand-writing-text-effect-online-990.html"
    if(//.test(command)) link = "https://textpro.me/sand-engraved-3d-text-effect-989.html"
    if(//.test(command)) link = "https://textpro.me/create-a-summery-sand-writing-text-effect-988.html"
    if(//.test(command)) link = "https://textpro.me/foil-balloon-text-effect-for-birthday-987.html"
    if(//.test(command)) link = "https://textpro.me/create-3d-glue-text-effect-with-realistic-style-986.html"
     ...
     if(//.test(command)) link = "https://textpro.me/neon-light-text-effect-with-galaxy-style-981.html"
     if(//.test(command)) link = "https://textpro.me/1917-style-text-effect-online-980.html"
     if(//.test(command)) link = "https://textpro.me/80-s-retro-neon-text-effect-online-979.html"
     if(//.test(command)) link = "https://textpro.me/minion-text-effect-3d-online-978.html"
     if(//.test(command)) link = "https://textpro.me/pornhub-style-logo-online-generator-free-977.html"
     if(//.test(command)) link = "https://textpro.me/double-exposure-text-effect-black-white-976.html"
     ...
     if(//.test(command)) link = "https://textpro.me/metal-purple-dual-effect-973.html"
      ...
      if(//.test(command)) link = "https://textpro.me/create-text-logo-3d-metal-online-957.html"
       if(//.test(command)) link = "https://textpro.me/create-avatar-gold-online-956.html"
       if(//.test(command)) link = "https://textpro.me/text-logo-3d-metal-silver-946.html"
       if(//.test(command)) link = "https://textpro.me/text-logo-3d-metal-rose-gold-945.html"
       ...
       if(//.test(command)) link = "https://textpro.me/xmas-cards-3d-online-942.html"
       if(//.test(command)) link = "https://textpro.me/blood-text-on-the-frosted-glass-941.html"
       if(//.test(command)) link = "https://textpro.me/halloween-fire-text-effect-940.html"
       if(//.test(command)) link = "https://textpro.me/metal-dark-gold-text-effect-online-939.html"
       if(//.test(command)) link = "https://textpro.me/create-lion-logo-mascot-online-938.html"
       if(//.test(command)) link = "https://textpro.me/create-wolf-logo-black-white-937.html"
       if(//.test(command)) link = "https://textpro.me/create-wolf-logo-galaxy-online-936.html"
       if(//.test(command)) link = "https://textpro.me/create-ninja-logo-online-935.html"
	if(//.test(command)) link = "https://textpro.me/create-logo-joker-online-934.html"
        if(//.test(command)) link = "https://textpro.me/wicker-text-effect-online-932.html"
        if(//.test(command)) link = "https://textpro.me/natural-leaves-text-effect-931.html"
        if(//.test(command)) link = "https://textpro.me/firework-sparkle-text-effect-930.html"
        if(//.test(command)) link = "https://textpro.me/skeleton-text-effect-online-929.html"
        if(//.test(command)) link = "https://textpro.me/red-foil-balloon-text-effect-928.html"
        if(//.test(command)) link = "https://textpro.me/purple-foil-balloon-text-effect-927.html"
        if(//.test(command)) link = "https://textpro.me/pink-foil-balloon-text-effect-926.html"
        if(//.test(command)) link = "https://textpro.me/green-foil-balloon-text-effect-925.html"
        if(//.test(command)) link = "https://textpro.me/cyan-foil-balloon-text-effect-924.html"
        if(//.test(command)) link = "https://textpro.me/blue-foil-balloon-text-effect-923.html"
        if(//.test(command)) link = "https://textpro.me/gold-foil-balloon-text-effect-922.html"
        if(//.test(command)) link = "https://textpro.me/steel-text-effect-online-921.html"
         if(//.test(command)) link = "https://textpro.me/ultra-gloss-text-effect-online-920.html"
         if(//.test(command)) link = "https://textpro.me/denim-text-effect-online-919.html"
         if(//.test(command)) link = "https://textpro.me/decorate-green-text-effect-918.html"
         if(//.test(command)) link = "https://textpro.me/decorate-purple-text-effect-917.html"
         if(//.test(command)) link = "https://textpro.me/peridot-stone-text-effect-916.html"
         if(//.test(command)) link = "https://textpro.me/rock-text-effect-online-915.html"
         if(//.test(command)) link = "https://textpro.me/lava-text-effect-online-914.html"
         if(//.test(command)) link = "https://textpro.me/yellow-glass-text-effect-913.html"
         if(//.test(command)) link = "https://textpro.me/purple-glass-text-effect-912.html"
         if(//.test(command)) link = "https://textpro.me/orange-glass-text-effect-911.html"
         if(//.test(command)) link = "https://textpro.me/green-glass-text-effect-910.html"
         if(//.test(command)) link = "https://textpro.me/cyan-glass-text-effect-909.html"
         if(//.test(command)) link = "https://textpro.me/blue-glass-text-effect-908.html"
          if(//.test(command)) link = "https://textpro.me/red-glass-text-effect-907.html"
          if(//.test(command)) link = "https://textpro.me/purple-shiny-glass-text-effect-906.html"
          if(//.test(command)) link = "https://textpro.me/captain-america-text-effect-905.html"
          if(//.test(command)) link = "https://textpro.me/robot-r2-d2-text-effect-903.html"
          if(//.test(command)) link = "https://textpro.me/rainbow-equalizer-text-effect-902.html"
          if(//.test(command)) link = "https://textpro.me/toxic-text-effect-online-901.html"
          if(//.test(command)) link = "https://textpro.me/pink-sparkling-jewelry-text-effect-899.html"
          if(//.test(command)) link = "https://textpro.me/blue-sparkling-jewelry-text-effect-898.html"
          if(//.test(command)) link = "https://textpro.me/green-sparkling-jewelry-text-effect-897.html"
          if(//.test(command)) link = "https://textpro.me/purple-sparkling-jewelry-text-effect-896.html"
          if(//.test(command)) link = "https://textpro.me/gold-sparkling-jewelry-text-effect-895.html"
          if(//.test(command)) link = "https://textpro.me/red-sparkling-jewelry-text-effect-894.html"
           if(//.test(command)) link = "https://textpro.me/cyan-sparkling-jewelry-text-effect-893.html"
           if(//.test(command)) link = "https://textpro.me/purple-glass-text-effect-online-892.html"
           if(//.test(command)) link = "https://textpro.me/decorative-glass-text-effect-891.html"
           if(//.test(command)) link = "https://textpro.me/chocolate-cake-text-effect-890.html"
           if(//.test(command)) link = "https://textpro.me/strawberry-text-effect-online-889.html"
           if(//.test(command)) link = "https://textpro.me/koi-fish-text-effect-online-888.html"
           if(//.test(command)) link = "https://textpro.me/bread-text-effect-online-887.html"
           if(//.test(command)) link = "https://textpro.me/matrix-style-text-effect-online-884.html"
           if(//.test(command)) link = "https://textpro.me/horror-blood-text-effect-online-883.html"
           if(//.test(command)) link = "https://textpro.me/neon-light-text-effect-online-882.html"
           if(//.test(command)) link = "https://textpro.me/create-thunder-text-effect-online-881.html"
           if(//.test(command)) link = "https://textpro.me/3d-box-text-effect-online-880.html"
           if(//.test(command)) link = "https://textpro.me/neon-text-effect-online-879.html"
            if(//.test(command)) link = "https://textpro.me/road-warning-text-effect-878.html"
            if(//.test(command)) link = "https://textpro.me/3d-steel-text-effect-877.html"
            if(//.test(command)) link = "https://textpro.me/bokeh-text-effect-876.html"
            if(//.test(command)) link = "https://textpro.me/free-advanced-glow-text-effect-873.html"
            if(//.test(command)) link = "https://textpro.me/dropwater-text-effect-872.html"
            if(//.test(command)) link = "https://textpro.me/break-wall-text-effect-871.html"
            if(//.test(command)) link = "https://textpro.me/chrismast-gift-text-effect-869.html"
            if(//.test(command)) link = "https://textpro.me/honey-text-effect-868.html"
            if(//.test(command)) link = "https://textpro.me/plastic-bag-drug-text-effect-867.html"
            if(//.test(command)) link = "https://textpro.me/horror-gift-text-effect-866.html"
            if(//.test(command)) link = "https://textpro.me/marble-slabs-text-effect-864.html"
            if(//.test(command)) link = "https://textpro.me/marble-text-effect-863.html"
             if(//.test(command)) link = "https://textpro.me/ice-cold-text-effect-862.html"
             if(//.test(command)) link = "https://textpro.me/fruit-juice-text-effect-861.html"
             if(//.test(command)) link = "https://textpro.me/rusty-metal-text-effect-860.html"
             if(//.test(command)) link = "https://textpro.me/abstra-gold-text-effect-859.html"
             if(//.test(command)) link = "https://textpro.me/biscuit-text-effect-858.html"
             if(//.test(command)) link = "https://textpro.me/bagel-text-effect-857.html"
             if(//.test(command)) link = "https://textpro.me/wood-text-effect-856.html"
             if(//.test(command)) link = "https://textpro.me/sci-fi-text-effect-855.html"
             if(//.test(command)) link = "https://textpro.me/metal-rainbow-text-effect-854.html"
             if(//.test(command)) link = "https://textpro.me/purple-gem-text-effect-853.html"
             if(//.test(command)) link = "https://textpro.me/shiny-metal-text-effect-852.html"
             if(//.test(command)) link = "https://textpro.me/yellow-jewelry-text-effect-851.html"
              if(//.test(command)) link = "https://textpro.me/silver-jewelry-text-effect-850.html"
              if(//.test(command)) link = "https://textpro.me/red-jewelry-text-effect-849.html"
              if(//.test(command)) link = "https://textpro.me/purple-jewelry-text-effect-848.html"
              if(//.test(command)) link = "https://textpro.me/orange-jewelry-text-effect-847.html"
              if(//.test(command)) link = "https://textpro.me/green-jewelry-text-effect-846.html"
