   ...
   if(/cloud5/.test(command)) link = "https://textpro.me/create-a-cloud-text-effect-on-the-sky-online-1004.html"
    ...
    if(/3D-glue-2/.test(command)) link = "https://textpro.me/create-3d-glue-text-effect-with-realistic-style-986.html"
     ...
     if(/metal-purple-2/.test(command)) link = "https://textpro.me/metal-purple-dual-effect-973.html"
      ...
      if(/luxury_metal-2/.test(command)) link = "https://textpro.me/deluxe-silver-text-effect-970.html"
      if(/glossyblue4/.test(command)) link = "https://textpro.me/color-full-luxury-metal-text-effect-969.html"
      if(/glossycarbon5/.test(command)) link = "https://textpro.me/glossy-blue-metal-text-effect-967.html"
      if(/fabric7/.test(command)) link = "https://textpro.me/deluxe-gold-text-effect-966.html"
      if(/newyear6/.test(command)) link = "https://textpro.me/glossy-carbon-text-effect-965.html"
      if(/newyeargif3/.test(command)) link = "https://textpro.me/fabric-text-effect-online-964.html"
      if(/color-balloon-2/.test(command)) link = "https://textpro.me/neon-text-effect-online-963.html"
      if(/3D-metal-2/.test(command)) link = "https://textpro.me/new-year-cards-3d-by-name-960.html"
      if(/avatargold4/.test(command)) link = "https://textpro.me/happ-new-year-card-firework-gif-959.html"
      if(/3D_metalsilver-2/.test(command)) link = "https://textpro.me/fullcolor-balloon-text-effect-958.html"
      if(/3D_rosegold-2/.test(command)) link = "https://textpro.me/create-text-logo-3d-metal-online-957.html"
